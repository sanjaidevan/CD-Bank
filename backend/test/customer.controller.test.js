...
describe("Customer Controller Unit Test", () => {
  ...
  it("Should get all accounts from a customer", async () => {
    ...
    expect(customerServices.fetchCustomerAccounts).toHaveBeenCalledWith(
      "4a3b74d8-1627-4e68-afd9-ed074d487c98",
    );
  ...
  it("Should return all Transactions", async () => {
    ...
    const req = {
      ...
      params: { accountNumber: "8795787924" },
    };
    const res = mockResponse();
    const next = vi.fn();
    await getTransactions(req, res, next);
    expect(customerServices.fetchTransactions).toHaveBeenCalledWith(
      8795787924,
      "4a3b74d8-1627-4e68-afd9-ed074d487c98",
    );
    expect(res.status).toHaveBeenCalledWith(200);
  ...
  it("Should return No Transactions Found", async () => {
    customerServices.fetchTransactions.mockResolvedValue([]);
    const req = {
      customer: {
        customerID: "4a3b74d8-1627-4e68-afd9-ed074d487c98",
  ...
  it("Should return No accounts found", async () => {
    customerServices.fetchCustomerAccount([]);
    const req = {
      customer: {
        customerID: "4a3b74d8-1627-4e68-afd9-ed074d487c98",
        firstName: "Guna",
