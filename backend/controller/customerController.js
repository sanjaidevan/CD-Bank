...
export const getAccountDetails = async (req, res, next) => {
  try {
    ...
    return res
      .status(200)
      .json({ customerName: accountHolder.firstName, accounts });
  } catch (error) {
    next(error);
  }
};
